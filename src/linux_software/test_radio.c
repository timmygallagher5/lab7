...
#define RADIO_TUNER_FAKE_ADC_PINC_OFFSET 1
#define RADIO_TUNER_TUNER_PINC_OFFSET 0
#define RADIO_TUNER_CONTROL_REG_OFFSET 2
#define RADIO_TUNER_TIMER_REG_OFFSET 3
#define RADIO_PERIPH_ADDRESS 0x43c00000
#define SYSTEM_CLOCK_HZ 125000000.0
...
void print_benchmark(volatile unsigned int *periph_base)
{
    ...
    float time_spent = clocks*period; // change obviously
    float throughput= bytes_transferred/time_spent;
    throughput /= 1000000.0;
    printf("You transferred %u bytes of data in %.9f seconds\n",bytes_transferred,time_spent);
    printf("Measured Transfer throughput = %2.5f Mbytes/sec\n",throughput);
}
...
// first, get a pointer to the peripheral base address using /dev/mem and the function mmap
    ...
    printf("\r\n\r\n\r\nLab 6 Timothy Gallagher - Custom Peripheral Demonstration\n\r");
